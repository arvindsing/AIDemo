...
import demoarv from "../../assets/demoarv.svg";
import Contoso from "../../assets/demoarv.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Ask any Question from Arvind SIngh chatting</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Arvind Singh Chatbot</h2>
                            </Stack>
                        ) : (
